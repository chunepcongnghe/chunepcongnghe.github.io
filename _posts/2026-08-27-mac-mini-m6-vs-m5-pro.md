...
key_takeaways:
  ...
  - "M6 có 12-core CPU/GPU, tối đa 32GB unified memory và 170GB/s memory bandwidth."
  - "M5 Pro có CPU tới 18 lõi, GPU tới 20 lõi, tối đa 64GB RAM và 307GB/s bandwidth."
  - "Bản M5 Pro có Thunderbolt 5; bản M6 dùng Thunderbolt 4."
...
quick_compare:
  ...
  - criterion: "Băng thông bộ nhớ"
    ...
    verdict: "M5 Pro có dư địa tốt hơn cho dữ liệu lớn và GPU."
  - criterion: "Thunderbolt"
    subject_value: "Thunderbolt 4"
    reference_value: "Thunderbolt 5"
    verdict: "M5 Pro hợp storage/monitor/cluster tốc độ cao hơn."
  - criterion: "Giá khởi điểm VN"
    subject_value: "24.999.000đ"
    reference_value: "47.999.000đ"
    verdict: "Khoảng giá chênh lớn nên chỉ lên Pro khi có nhu cầu thật."
date: 2026-08-27T08:40:00+07:00
section: so-sanh
...
M6 là chip cơ bản thế hệ mới, tập trung hiệu năng đơn luồng, AI mới và hiệu suất điện năng. M5 Pro là chip cấp Pro của thế hệ trước một nhịp, nhưng được mở rộng về số lõi, memory bandwidth và khả năng kết nối.

| Hạng mục | Mac mini M6 | Mac mini M5 Pro |
|---|---:|---:|
| CPU | 12 lõi | Tới 18 lõi |
| GPU | 12 lõi | Tới 20 lõi |
| Unified memory tối đa | 32GB | 64GB |
| Băng thông memory | 170GB/s | 307GB/s |
| Thunderbolt | TB4 | TB5 |
| Giá VN từ | 24,999 triệu | 47,999 triệu |

## Khi nào M6 thực sự hợp hơn?
...
Final Cut, CapCut, Premiere ở mức social/YouTube, ít effect nặng và không làm 3D thường không cần tới 64GB RAM hay 20 GPU cores.
...
M5 Pro có GPU nhiều lõi hơn, memory bandwidth gần gấp đôi và ray tracing thế hệ mới. Khi project có nhiều node, texture lớn, ProRes RAW hoặc render dài, chênh lệch cấp chip bắt đầu có ý nghĩa thực sự.
...
Một lỗi rất phổ biến là suy luận:
