...
quick_compare:
  - criterion: "Chi phí"
    subject_value: "Thường thấp hơn nếu đúng điểm nghẽn"
  ...
  - criterion: "Phạm vi cải thiện"
    subject_value: "Một hoặc vài điểm nghẽn"
...
---
Có hai kiểu nâng cấp tốn tiền nhất: **nâng một thứ không phải điểm nghẽn** và **đổi cả máy khi chỉ thiếu một linh kiện**. Cách tránh cả hai là đo vấn đề trước.
